    ...
    if (data.city) {
      ...
      return ( < div className = 'main-content fade-in' >
        < h1 > {
          ...
          date
        } < /h2> < WeatherStyle wstyle = {
          weatherType
        }
        /> < h3 > {
          weatherTypeDetail
        } < /h3> < div className = 'weather-info' >
        < div className = 'info1' >
        < div className = 'day' > < img src = '../../images/sun80.png' / > {
          dayTemp
        }
        F < /div> < div className = 'night' > < img src =
        '../../images/moon80.png' / > {
          nightTemp
        }
        F < /div> < /div> < div className = 'info2' >
        < div className = 'humidity' > < img src =
        '../../images/humidity80.png' / > {
          humidity
        } % < /div> < div className = 'wind' > < img src =
        '../../images/wind80.png' / > {
          windSpeed
        }
        mph < /div> < /div> < /div> < /div>
      ...
      return ( < div className = 'landing-box' >
        < h2 className = 'landing-h2' > Weather
        for the week < /h2> < div > < img src =
        '../../images/weather-combo.png'
